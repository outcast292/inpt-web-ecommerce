...
if ($_GET["nom"] == null) {
    ...
    $query = "INSERT into utilisateurs (nom_user,prenom_user,email_user,mdp_user,is_admin,tel_user,fonction) values(:nom_user,:prenom_user,:email_user,:mdp_user,:is_admin,:tel_user,:fonction  );";
