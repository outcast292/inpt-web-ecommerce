        ...
        <div class="row">
            ...
            <div class="col pt-4">
                ...
                <form id="form_search">
                    ...
                    <div class="row">
                        <div class="col-6">
                            <input class="form-control" list="categories_options" type="search" id="search_categories" placeholder="Type to search...">
                ...
                if (!categories.includes(nom_categorie))
                    fetch("../php/categories/add?nom_categorie=" + nom_categorie).then(resp => resp.json()).then(json => {
                        ...
                        <tr>
                            ...
                            <td>
                            <button class="btn btn-danger btn-block dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Options</button>
                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton">
